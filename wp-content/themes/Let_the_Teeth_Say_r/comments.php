...
<?php if ( have_comments() ) : ?>
	<h3 id="comments"><?php comments_number('Нет комментариев', 'Комментариев: 1', 'Комментариев: %' );?> к &#8220;<?php the_title(); ?>&#8221;</h3>
...
<p>Вы должны быть <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php echo urlencode(get_permalink()); ?>">авторизованы</a>, если хотите оставлять комментарии.</p>
<?php else : ?>
...
<label for="email"><small>Mail (не публикуется<?php if ($req) echo ", обязательно"; ?>)</small></label></p>
