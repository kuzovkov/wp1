...
<head>
    ...
    <script src="<?php bloginfo('stylesheet_directory');?>/js/jquery-1.6.3.min.js" type="text/javascript"></script>
    <script src="<?php bloginfo('stylesheet_directory');?>/js/cufon-yui.js" type="text/javascript"></script>
    <script src="<?php bloginfo('stylesheet_directory');?>/js/cufon-replace.js" type="text/javascript"></script>
    <script src="<?php bloginfo('stylesheet_directory');?>/js/Lobster_13_400.font.js" type="text/javascript"></script>
    <script src="<?php bloginfo('stylesheet_directory');?>/js/NewsGoth_BT_400.font.js" type="text/javascript"></script>
    <script src="<?php bloginfo('stylesheet_directory');?>/js/FF-cash.js" type="text/javascript"></script>
    <script src="<?php bloginfo('stylesheet_directory');?>/js/easyTooltip.js" type="text/javascript"></script>
    <script src="<?php bloginfo('stylesheet_directory');?>/js/script.js" type="text/javascript"></script>
    <script src="<?php bloginfo('stylesheet_directory');?>/js/bgSlider.js" type="text/javascript"></script>
    <script src="<?php bloginfo('stylesheet_directory');?>/js/jquery.easing.1.3.js" type="text/javascript"></script>
    <script src="<?php bloginfo('stylesheet_directory');?>/js/tms-0.3.js" type="text/javascript"></script>
    <script src="<?php bloginfo('stylesheet_directory');?>/js/tms_presets.js" type="text/javascript"></script>
    <!--[if lt IE 9]>
            ...
            <div class="main">
                <div class="wrapper">
                    ...
                    <ul class="pagination">
                        ...
                        <li><a href="<?php bloginfo('stylesheet_directory');?>/images/bg-img3.jpg">3</a></li>
                    </ul>
